$PBExportHeader$w_demo_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_demo_frame from window
end type
type mdi_1 from mdiclient within w_demo_frame
end type
end forward
...
global w_demo_frame w_demo_frame

type variables
n_demo_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_demo_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_demo_sheet1", "w_demo_sheet2", "w_demo_sheet3" }
...
inv_sheetmgt = Create n_demo_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_demo_frame.create
if this.MenuName = "m_demo_frame" then this.MenuID = create m_demo_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_demo_frame.destroy
