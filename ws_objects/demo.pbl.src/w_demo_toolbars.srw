$PBExportHeader$w_demo_toolbars.srw
$PBExportComments$Generated MDI Toolbar Configuration
forward
global type w_demo_toolbars from window
end type
type rb_floating from radiobutton within w_demo_toolbars
end type
type rb_bottom from radiobutton within w_demo_toolbars
end type
type rb_right from radiobutton within w_demo_toolbars
end type
type rb_top from radiobutton within w_demo_toolbars
end type
type rb_left from radiobutton within w_demo_toolbars
end type
type cb_done from commandbutton within w_demo_toolbars
end type
type cb_visible from commandbutton within w_demo_toolbars
end type
type cbx_showtips from checkbox within w_demo_toolbars
end type
type cbx_showtext from checkbox within w_demo_toolbars
end type
type gb_options from groupbox within w_demo_toolbars
end type
end forward
...
global w_demo_toolbars w_demo_toolbars
